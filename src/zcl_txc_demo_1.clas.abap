CLASS zcl_txc_demo_1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_txc_demo_1 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    out->write( 'Demo 1 - BAPI Classic Pattern' ).
    ...
    TRY.
        ...
        organization-name1 = |CCH – Congress Center Demo 1 - { sy-uzeit } |.
